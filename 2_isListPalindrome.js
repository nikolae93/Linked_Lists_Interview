...
/*
Note: Try to solve this task in O(n) time using O(1) additional space, where n is the number
...
const isListPalindrome = (l) => {
    const nodeArray = getArrayFromList(l);
 
    return nodeArray.join('') === nodeArray.reverse().join('');
}
